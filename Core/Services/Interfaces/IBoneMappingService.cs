...
namespace Tiloop.ConstraintLinkSetupTool.Core.Services.Interfaces
{
    public interface IBoneMappingService
    {
        ...
        /// </summary>
        /// <param name="avatarRoot">アバター全体のルートTransform</param>
        /// <param name="prostheticRoot">パーツ（義手）側のルートTransform</param>
        ...
        List<BonePair> MatchBones(Transform avatarRoot, Transform prostheticRoot, Transform avatarBaseBone, Transform prostheticBaseBone, SideMode sideMode);
    }
}
